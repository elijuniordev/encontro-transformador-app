...
import tailwindcssAnimate from "tailwindcss-animate"; // Importação corrigida
...
export default {
    ...
    theme: {
        ...
        extend: {
            ...
            keyframes: {
                ...
                'divine-glow': {
                    '0%, 100%': {
                        boxShadow: '0 0 10px hsl(var(--primary-glow) / 0.15)'
                    },
                    '50%': {
    ...
    plugins: [tailwindcssAnimate], // Referência corrigida
} satisfies Config;