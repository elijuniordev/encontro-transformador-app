...
import { Tooltip, TooltipContent, TooltipTrigger, TooltipProvider } from "@/components/ui/tooltip"; // Adicionado TooltipProvider
        ...
        <Select
          ...
          onValueChange={(value) => {
            ...
            if (['Pendente', 'Cancelado', 'Isento'].includes(value)) {
              newData.forma_pagamento = null; // Limpa a forma de pagamento
            }
            setEditData(newData);
          }}
        >
