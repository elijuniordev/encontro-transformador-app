...
const InscriptionForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Lista de situações que não requerem discipulador/líder
    const situationsWithoutLeaders = ["Equipe", "Cozinha", "Pastor, obreiro ou discipulador"];

    // Validação básica - Ignora anjoDaGuarda e lider para as situações específicas
    ...
    if (!formData.nomeCompleto || !formData.sexo || !formData.idade || !formData.whatsapp || !formData.situacao) {
      toast({
        title: "Campos obrigatórios",
        description: "Por favor, preencha todos os campos obrigatórios.",
        variant: "destructive"
    ...
    try {
      ...
      const inscriptionData = {
        ...
        // Limpa anjo_guarda e lider se a situação não requer
          ...
          <CardContent>
            ...
            {!isRegistrationsOpen ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Select 
                      ...
                      // Adicionado: desabilita se a situação não requer um discipulador
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                      ...
                      // Adicionado: desabilita se a situação não requer um líder ou se o discipulador não foi selecionado
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    // Adicionado: desabilita se a situação não requer anjo da guarda
                    disabled={["Equipe", "Cozinha", "Pastor, obreiro ou discipulador"].includes(formData.situacao)}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.situacao} onValueChange={(value) => {
                    setFormData({ ...formData, situacao: value });
                    // Limpa os campos de líder e discipulador se a situação não os requer
